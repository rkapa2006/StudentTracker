...
public class PrintPdf {
	...
	private static final Logger LOG = Logger.getLogger(PrintPdf.class);
	private PrinterJob pjob = null;

	public PrintPdf(File pdfFile) throws IOException, PrinterException {
		this(new FileInputStream(pdfFile), pdfFile.getName());
	}
